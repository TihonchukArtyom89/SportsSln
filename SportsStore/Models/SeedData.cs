    ...
    public static void EnsurePopulated(IApplicationBuilder app)
    {
        ...
        if (!context.Products.Any())
        {
            context.Products.AddRange(
                ...
                new Product { Name = "Thinking Cap", Description = "Improve brain efficiency", Category = "Chess", Price = 16 },
                new Product { Name = "Usteady Chair", Description = "Secretly give your opponent a disadvantage", Category = "Chess", Price = 29.95m },
